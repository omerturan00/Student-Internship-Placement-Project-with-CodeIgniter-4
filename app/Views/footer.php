...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Omer Turan Web Development</span>
        </div>
    </div>
</footer>
</div>
...
<script src="<?=base_url()?>/webfiles/assets/vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?=base_url()?>/webfiles/assets/vendor/datatables/dataTables.bootstrap4.min.js"></script>
<script src="<?=base_url()?>/webfiles/assets/js/demo/datatables-demo.js"></script>
